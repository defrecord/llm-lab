...
#+RESULTS:
: Hello! I'm here to help you generate a conventional commit message for your Git diff output.
: 
: Can you please provide the Git diff output that you'd like me to analyze? You can paste the entire diff, and I'll do my best to identify the type of change and craft a suitable commit message according to the Conventional Commits specification.
