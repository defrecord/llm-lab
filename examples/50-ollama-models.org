...
#+begin_src shell :llm t :results file :file ../data/proxy-config.txt :tangle ../data/proxy-config.sh
echo $HTTP_PROXY
echo $HTTPS_PROXY
#+end_src

#+RESULTS:
[[file:proxy-config.txt]]
