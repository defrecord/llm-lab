...
#+begin_src shell :llm t :results file :file analysis/framework-recommendation.md 
...
#+begin_src shell :llm t :results file :file analysis/raid-analysis.md
...
#+begin_src shell :llm t :results file :file analysis/structure-analysis.md
